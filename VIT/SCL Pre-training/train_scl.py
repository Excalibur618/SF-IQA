...
def main(args):
    ...
    root_dir='../../CONTRIQUE-main/training_data/kadis700k'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bsize', type=int, default=64, help='batch_size')
    parser.add_argument('--psize', type=int, default=128, help='patch_size')
