...
class image_data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        div_factor = np.random.choice([1,2],1)[0]
        colorspace_choice=np.random.choice([0],1)[0]
        image_3=ResizeCrop(image_orig, self.image_size, div_factor)
        image_3=colorspaces(image_3, colorspace_choice)
        image_3 = self.tranform_toT(image_3)

        
        return image, image_2, image_3, label
