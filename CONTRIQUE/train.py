...
from modules.CONTRIQUE_model import VIT
...
def train(args, train_loader_syn, train_loader_ugc, \
    ...
    for step,((syn_i1, syn_i2, syn_i3, dist_label_syn),(ugc_i1, ugc_i2, ugc_i3, _)) in \
...
def main(gpu, args):
    ...
    encoder = VIT(embed_dim=args.embed_dim, num_outputs=args.num_outputs, dim_mlp=args.dim_mlp,
            patch_size=args.patch_size, img_size=args.img_size, window_size=args.window_size,
            depths=args.depths, num_heads=args.num_heads, num_tab=args.num_tab, scale=args.scale)
    args.n_features = 384 # get dimensions of fc layer
...
def parse_args():
    ...
    parser.add_argument('--num_outputs',type=int,default=1,\
                        help='num_ooutputs')
    parser.add_argument('--dim_mlp',type=int,default=769,\
                        help='dim_mlp')
    ...
    parser.add_argument('--window_size',type=int,default=4,\
                        help='widow_size')
    parser.add_argument('--depths',type=tuple,default=[2,2],\
                        help='depths')
    parser.add_argument('--num_heads',type=tuple,default=[4,4],\
                        help='num_heads')
    parser.add_argument('--num_tab',type=int,default=2,\
                        help='num_tab')
