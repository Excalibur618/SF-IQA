...
def train_fn(args):
    root_dir = os.getcwd()
    root_dir='../CONTRIQUE-main/sample_images'
    ...
    kadid10k_path = os.path.join(root_dir, 'kadid10k')
    koniq_path = os.path.join(root_dir, 'dataset_iqa', 'koniq')
    tid2013_path = os.path.join(root_dir, 'tid2013')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dset', type=str, default='tid2013', help='dataset')
    ...
    parser.add_argument('--model_name_scl', type=str, default='iqa-97-msb', help='SCL model name')
